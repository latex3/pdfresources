...
\makeatletter
\show\pgf@sys@pgf@resource@list@colorspaces
\show\pgf@sys@pgf@resource@list@patterns
\ExplSyntaxOn
%Trying to patch pdf ...
...
% }
  ...
  \exp_args:Nno \__pdf_dict_entry_split:w {ColorSpace}\pgf@sys@pgf@resource@list@colorspaces\q_stop
\ExplSyntaxOff
